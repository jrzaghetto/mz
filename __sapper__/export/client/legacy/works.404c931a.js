...
var file = "src/routes/works.svelte";
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Works> was created with unknown prop '".concat(key, "'"));
  });
...
var Works = /*#__PURE__*/function (_SvelteComponentDev) {
  _inherits(Works, _SvelteComponentDev);

  var _super = _createSuper(Works);

  function Works(options) {
    var _this;
